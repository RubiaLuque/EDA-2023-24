...
public:
    ...
    //ya que al estar ordenados, con recorrer en cada set el tamaño del menor, deberia ser suficiente
    ...
    //ya que debe recorrer ambos sets por completo para añadir todos los elementos de cada uno
    //sin repeticiones
    Set<T> operator||(const Set<T>& other) const {
